...
export const headerStyles = stylex.create({
	...
	brand: {
		...
		zIndex: 2,
		display: "flex",
		width: { default: "auto", [mobile]: "44px" },
		height: { default: "auto", [mobile]: "44px" },
		minWidth: 0,
		alignItems: "center",
		justifyContent: { default: "flex-start", [mobile]: "center" },
		marginInlineStart: { default: 0, [mobile]: "-8px" },
	...
	button: {
		...
		borderColor: {
			...
			":hover": { default: colors.borderStrong, [canHover]: colors.borderStrongHover },
		},
		borderRadius: lengths.radiusControl,
		color: colors.foreground,
		backgroundColor: {
	...
	sheetAction: { flexGrow: 1, flexShrink: 1, flexBasis: 0, width: "auto", minWidth: 0, minHeight: "44px", justifyContent: "center" },
	textLink: {
		display: "inline-flex",
		alignItems: "center",
		columnGap: "4px",
